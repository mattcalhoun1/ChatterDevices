...
#define MENU_MAIN_BACKPACK_TRIGGER 98
#define MENU_MAIN_CONNECTIONS 97
#define MENU_MAIN_BACKUPS 96
...
#define MENU_SECURITY_CHANGE_PASSWORD 1
#define MENU_SECURITY_KEY_TEST 2
#define MENU_SECURITY_LOCK_TRUSTSTORE 3
#define MENU_SECURITY_KEY_FORWARDING 4
...
#define MENU_DEVICE_ENABLE_DST 4
#define MENU_DEVICE_ALLOW_EXPIRED_MESSAGES 5
#define MENU_DEVICE_SHOW_ID 6
